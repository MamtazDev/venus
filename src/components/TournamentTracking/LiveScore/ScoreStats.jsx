...
const ScoreStats = () => {
  return (
    <>
      <h3 style={{ fontSize: "24px" }} className="text6 mb-[20px]">
        Top Performance
      </h3>
      <div className="grid lg:grid-cols-2 grid-cols-1 gap-20">
        <div className="p-20 bg-white rounded-3">
          <p className="border-b border-light_sky text6 pb-20 ">
            Top Run Scorers
          </p>
          {[1, 2, 3].map((data, index) => (
            <>
              <div
                key={index}
                className="flex items-center gap-10 border-b border-light_sky "
              >
                <div>
                  <img src={profile} alt="" />
                </div>
                <div className="py-[12px] ">
                  ...
                  <span className="text-[12px] font-normal  font-sans text-[#A8A8A8] mt-[2px]">
                    Innings: 35{" "}
                  </span>
                  <span className="text-[12px] font-normal  font-sans text-[#A8A8A8] mt-[2px]">
                    Average: 36.8
