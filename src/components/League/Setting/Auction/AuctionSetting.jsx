                ...
                <table className="table">
                    ...
                    <tbody>
                        ...
                        <tr className="bg-sky border border-[#E1E1E1] flex justify-between items-center w-full  ps-[24px]">
                            ...
                            <td className="font-medium text-sm text-text_color1 ">
                                <input type="text" defaultValue="$ 1" className='p-10 bg-white rounded-8 opacity-100 border border-[#E1E1E1]' placeholder='$ 1' />
                            </td>
                        </tr>
                        <tr className="bg-sky border border-[#E1E1E1] flex justify-between items-center w-full  ps-[24px]">
                        ...
                        <tr className="bg-sky border border-[#E1E1E1] flex justify-between items-center w-full  ps-[24px]">
                            ...
                            <td className="font-medium text-sm text-text_color1 ">
                                <input type="text" defaultValue="$" className='p-10 bg-white rounded-8 opacity-100 border border-[#E1E1E1]' placeholder='' />
                            </td>
                        </tr>
