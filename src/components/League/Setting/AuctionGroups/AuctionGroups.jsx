    ...
    <>
          ...
          <tbody>
            ...
            <tr className="bg-sky border border-[#F0F0F0]  ">
              ...
              <td className="font-medium text-sm text-text_color1  text-left">
                <p className="text3 inline-block border-b border-border3 pb-[6px]">
                  Arizona Cardinals
                </p>
              ...
              <td className="font-medium text-sm text-text_color1 text-end ">
                <button className="px-14 py-12 w-[112px] bg-[#F00] rounded-8 font-sans font-semibold text-white ">
                  Delete
                </button>
              </td>
            </tr>
      ...
      <div className="flex justify-center mt-[30px] ">
        <button
          ...
          onClick={() => document.getElementById("add_new_group").showModal()}
        >
          New Group
        </button>
      </div>
      ...
      <dialog id="add_new_group" className="modal">
        ...
        <label
          ...
          htmlFor="add_new_group"
          onClick={() => document.getElementById("add_new_group").close()}
        >
          Close
        </label>
      </dialog>
