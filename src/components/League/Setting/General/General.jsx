        ...
        <>
            ...
            <div className='flex flex-col gap-20'>
                ...
                <div className="p-20 bg-white  rounded-3 invite_id">
                    ...
                    <input type="text" className="  w-full border-0 py-10 ps-20 font-sans text-sm text-[#000] bg-light_sky mt-[15px] cursor-copy" value="https://calcuttaleague.com/joinLeague?inviteCode=BC357183-ED2F-4396-83F5-BC30431977BD" />
