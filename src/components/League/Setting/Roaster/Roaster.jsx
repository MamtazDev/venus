                ...
                <table className="table font-sans">
                    <thead className="bg-white">
                        <tr className="border-0">
                            <th className="text-sm font-sans text-center  font-medium text-text_color1 ">Username  </th>
                            <th className="text-sm font-sans text-center  font-medium text-text_color1 ">Teams Purchased</th>
                            <th className="text-sm font-sans text-center  font-medium text-text_color1 ">Role</th>
                    ...
                    <tbody>
                        ...
                        <tr className="bg-sky border border-[#F0F0F0] ">
                            <td className="font-sans text-center font-medium text-sm text-text_color1 ">Shamin</td>
