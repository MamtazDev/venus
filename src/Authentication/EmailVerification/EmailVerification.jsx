        ...
        <div>
          ...
          <div className="login_wrapper login_padding">
            <div className="flex flex-col items-center justify-center ">
              ...
              <p className="text-base text222color">
                Enter the OTP code that was sent your email
              </p>
            </div>
              ...
              <div className="flex flex-col gap-5 ">
                <div>
                  ...
                  <input
                    ...
                    className="w-full input_field input input-bordered mt-[10px]"
                  />
                </div>
              </div>
              <button
                type="submit"
                className="w-full text-white mt-[61px]  py-21 bg-base rounded-[3px] text-lg font-semibold"
              >
                Verified
              </button>
            </form>
